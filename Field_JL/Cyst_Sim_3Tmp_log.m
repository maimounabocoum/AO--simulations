...
R = 2.5/1000;            % Radius of the transducer [mm]
Rfocal = 10/1000;       % Focal radius of the transducer [mm]
...
InfoBeam.YDebut  = -10;  InfoBeam.YFin  = 10;     InfoBeam.pasY  = .5;
InfoBeam.ZDebut  = 1;  InfoBeam.ZFin  = 50;    InfoBeam.pasZ  = .5;
...
champF=(Dpl);
%champF=20*log10(Dpl./Dpl(1,1+10/0.25,11));
