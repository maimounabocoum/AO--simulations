...
InfoBeam.XDebut  = -2*R;  InfoBeam.XFin  = 2*R;  InfoBeam.pasX  = 1/1000;
InfoBeam.ZDebut  = -2*R;  InfoBeam.ZFin  = 2*R;    InfoBeam.pasZ  = 1/1000;
InfoBeam.YDebut  = 2*R;  InfoBeam.YFin  = 10*R;   InfoBeam.pasY  = 3/1000;
...
Dpl = reshape(Force,InfoBeam.NbX,InfoBeam.NbZ,InfoBeam.NbY);
...
for i=1:InfoBeam.NbY
    ...
    saveas(gcf,['PressureField_1_' num2str(i)], 'jpg')
    pause;
    close(gcf)
