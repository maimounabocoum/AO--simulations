...
InfoBeam.XDebut  = -R;  InfoBeam.XFin  = R ;  InfoBeam.pasX  = 1/1000;
InfoBeam.ZDebut  = -R;  InfoBeam.ZFin  = 44.95;   InfoBeam.pasZ  = 1/1000;
InfoBeam.YDebut  = 2*R;  InfoBeam.YFin  = 5*R;    InfoBeam.pasY  = 1/1000;

A = -InfoBeam.XDebut:InfoBeam.pasX:InfoBeam.XFin;
B = -InfoBeam.YDebut:InfoBeam.pasY:InfoBeam.YFin;
C = -InfoBeam.ZDebut:InfoBeam.pasZ:InfoBeam.ZFin;
