...
transducer.focus_distance = 35e-3;              % focus distance [m]
transducer.elevation_focus_distance = 35e-3;    % focus distance in the elevation plane [m]
...
% run the simulation
[sensor_data] = kspaceFirstOrder2D(kgrid, medium, transducer, sensor, input_args{:});
