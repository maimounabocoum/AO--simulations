...
param.angles      = [-30:30]*pi/180;    % Angular scan [m,m,m]                  - only active in OP and OS mode 
...
param.decimation  = [];  % decimation list of active actuators   - only active in OS mode 
